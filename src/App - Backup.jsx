...
const Card = ({ children, style = {} }) => (
  <div style={{ background: C.bgCard, border: `1px solid ${C.border}`, borderRadius: "10px", padding: "18px", ...style }}>
    {children}
  </div>
);

const Sec = ({ children }) => (
  <div style={{ fontSize: "15px", color: C.accent, letterSpacing: "0.12em", textTransform: "uppercase", fontFamily: "monospace", marginBottom: "14px", borderBottom: `1px solid ${C.border}`, paddingBottom: "7px" }}>
    {children}
  </div>
);
...
export default function SentientGrid() {
  ...
  const { rows, kpi } = useMemo(() => {
    ...
    for (let abs = 1; abs <= 60; abs++) {
      ...
      const pipeline = Math.round(clients / (pipelineConversion / 100));
        ...
        {tab === "inputs" && (
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(265px, 1fr))", gap: "14px" }}>
              ...
              <div style={{ background:C.bg, borderRadius:"6px", padding:"9px", marginTop:"8px", border:`1px solid ${C.border}` }}>
                {[["Yr5 Valuation",fmtINR(kpi.yr5Val)],["Yr5 EBITDA",fmtINR(kpi.yr5EBITDA)],["Yr5 Rev Needed",fmtINR(kpi.yr5Rev)]].map(([l,v])=>(
                  <div key={l} style={{ display:"flex", justifyContent:"space-between", padding:"3px 0", fontSize:"16px", borderBottom:`1px solid ${C.border}` }}>
                    <span style={{color:C.muted}}>{l}</span><span style={{color:C.accent}}>{v}</span>
                  </div>
                ))}
              </div>
            </Card>
            ...
            <Card>
              ...
              <div style={{ background:C.bg, borderRadius:"6px", padding:"10px", marginTop:"10px", border:`1px solid ${C.border}`, fontSize:"16px", lineHeight:1.9 }}>
            ...
            <Card>
              ...
              <div style={{ background:C.bg, borderRadius:"6px", padding:"9px", marginTop:"10px", border:`1px solid ${C.border}` }}>
                {[["1 AED",`₹${inp.aedToInr}`],["1 EUR",`₹${inp.eurToInr}`],["1 AUD",`₹${inp.audToInr}`]].map(([l,v])=>(
                  <div key={l} style={{ display:"flex", justifyContent:"space-between", padding:"3px 0", fontSize:"16px" }}>
                    <span style={{color:C.muted}}>{l}</span><span style={{color:C.text}}>{v}</span>
                  </div>
                ))}
              </div>
            </Card>
            ...
            <Card>
              ...
              <div style={{ background:C.bg, borderRadius:"6px", padding:"9px", marginTop:"8px", border:`1px solid ${C.border}`, fontSize:"16px", lineHeight:1.9 }}>
            ...
            <Card>
              <Sec>💸 Monthly Fixed Expenses</Sec>
              ...
              <div style={{ background:C.bg, borderRadius:"6px", padding:"9px", marginTop:"8px", border:`1px solid ${C.border}` }}>
                <div style={{ display:"flex", justifyContent:"space-between", fontSize:"17px", fontWeight:600 }}>
                  <span style={{color:C.muted}}>Base Monthly Burn</span>
                ...
                <div style={{ display:"flex", justifyContent:"space-between", fontSize:"16px", marginTop:"4px" }}>
                  <span style={{color:C.muted}}>Runway</span>
